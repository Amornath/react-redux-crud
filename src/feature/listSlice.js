...
export const getLists = createAsyncThunk("list/getLists", async () => {
  return fetch(`http://localhost:8000/students`).then((res) => res.json());
});

export const updateList = createAsyncThunk("list/updateList", async (data) => {
  return fetch(`http://localhost:8000/students/` + data.id, {
    method: "PUT",
    headers: {
