...
import { Row, Card, Col, Table, Form, Button, Spinner, Container, Nav, Navbar } from "react-bootstrap";
...
const List = () => {
  ...
  const deleteRowClick =(item)=>{
    fetch(
      `http://localhost:8000/students/`+item.id, {
          method: "DELETE",
...
<Container>
  <Row className='mt-3'>
    <Col>
    <Card>
    <Button variant="primary" type="submit" onClick={()=>setStudent({name:"", roll:"", clss:""})}>
                Add New
    </Button>
            <Form
              noValidate
    ...
    <Card>
            <Table responsive striped borderless>
              ...
              <tbody>
                ...
                <Button variant="danger" onClick={()=>deleteRowClick(item)} >
